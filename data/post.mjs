...
const SELECT_JOIN =
  "select p.id, p.text, p.creatAt, u.userid, u.name, url from users as u join posts as p on u.idx = p.useridx";
const ORDER_DESC = "order by p.creatAt desc";
const ORDER_ASC = "order by p.creatAt asc";
